...
string string_clone(const string str) { return (string_create(str->content)); }
...
void string_dump(string str, FILE *file) { fprintf(file, "%s", str->content); }

const char *string_ref(string str) { return (str->content); }
