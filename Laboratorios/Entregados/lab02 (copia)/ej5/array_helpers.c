...
unsigned int array_value_count(fixstring a[], unsigned int length,
                               fixstring value) {
...
bool array_is_permutation_of(fixstring a[], fixstring b[],
                             unsigned int length) {
  unsigned int i = 0;
  bool result = true;
...
unsigned int array_from_file(fixstring array[], unsigned int max_size,
                             const char *filepath) {
  FILE *file = NULL;
